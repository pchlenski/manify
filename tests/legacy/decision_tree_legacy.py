# FROZEN legacy snapshot of manify/predictors/decision_tree.py.
# Do NOT edit; do NOT import from the library. Bit-exact oracle for the CART
# refactor parity tests (see docs/design/cart_refactor.md). Retained permanently
# to guard noncircular (Euclidean/Hyperbolic) parity.
...
from manify.predictors._base import BasePredictor
from manify.predictors._midpoint import midpoint
